...
argSpec <- matrix(c(
    ...
    'output', 'o', 1, 'character', "Top Rank Words of each Topics, CSV File (Default topwords_{input}.csv)",
    'rates', 'r', 2, 'character', "(Optional) Proportions of Top Rank Words in each Topics, CSV File (Default wordsrate_{input}.csv)"
), byrow=TRUE, ncol=5)
...
cat("Select Top Rank Words of each Topics... ")
...
if (shouldMakeRates) {
    cat("Calculate Proportions of Top Rank Words in each Topics... ")
